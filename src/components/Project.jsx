...
export default function Project() {
  return (
    <>
      ...
      <h2 class="w3-text-grey w3-padding-16">A Glimps into My Work  <i class="fa fa-window-restore fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i></h2>
        <div class="w3-container w3-card">
          ...
          <hr/>
          <p><b>DMS (Paperless Office Management) | Square InformatiX Limited (Concern Of Square Group)</b></p>
          <h6 class="w3-text-teal"><i class="fa fa-image fa-fw w3-margin-right"></i></h6>
          ...
          <hr/>
          <p><b>Forex Trading Software (Analyzing Currency Reporting with multilingual version support) | IT Grow Division LTd ! InstaForex</b></p>
          <h6 class="w3-text-teal"><i class="fa fa-image fa-fw w3-margin-right"></i></h6>
...
<div>
  ...
  <hr/>
          ...
          <p><b>ERP for HATIL | DI System LTD</b></p>
          <h6 class="w3-text-teal"><i class="fa fa-image fa-fw w3-margin-right"></i></h6>
